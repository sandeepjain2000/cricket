#!/usr/bin/env python3
"""
Cricket T20 & LOI Downloader - FORCE RECREATE SCHEMA VERSION
Uses exact same schema as Test database for consistency
Forces table recreation by dropping existing tables first
"""
...
SCRIPT_NAME = "cricket_t20_loi_force_recreate.py"
VERSION = "3.0.0"
...
log(f"  T20 & LOI Downloader (FORCE RECREATE SCHEMA)")
...
# Schema with DROP TABLE IF EXISTS to force recreation.
# Aligned with Test DB expectations (rankings API needs matches.start_date + match_players).
SCHEMA_SQL = """
